...
//get back a reference for the script
export const contentPromptsStarter: { [key in system]: string } = {
    script:
    `Using the provided topics {{topicsToReplace}} Merge these topics into a unified narrative that ties the different subjects together in a meaningful way. Based on this information, craft a 30-second video script optimized for virality. You are just searching for content on the various social media sites, or across the internet. Do not mention the social media sites you used for research in the script. The script should include:
