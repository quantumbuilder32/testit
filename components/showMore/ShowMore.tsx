...
export default function ShowMore({ label, content, svgColor, wantsToShowAll, startShowing, labelStyle }: { label: string, content: JSX.Element, svgColor?: string, wantsToShowAll?: boolean, startShowing?: boolean, labelStyle?: React.CSSProperties }) {
